...
vars.wdi <- c(v.income, v.inccap, v.savingrate, v.saving, v.gini)

income <- WDI(indicator = vars.wdi,start = 2000, end=2012)
##      Remember ... if you later want GROUPs such as lending, income, etc. you can add `, extra=TRUE` above)
...
inc2010 <- inc.dt[year==2010,.SD, .SDcols=c("iso2c","country","year","income","inccap","gini","saving","savrate")]
