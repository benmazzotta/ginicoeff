...
set.seed(4925)
## For g==".35"
t.gini <- .35; t.sigma <- sqrt(2)*qnorm((t.gini+1)/2)
t.gini; t.sigma; log(t.sigma)
toy <- rlnorm(10^4, 0, t.sigma)
summary(toy)
toy <- toy[order(toy)]
...
inc2010[,inc.p20 := qlnorm(p20, meanlog=log(mu), sdlog=sigma)]
inc2010[,inc.psav := qlnorm(psav, meanlog=log(mu), sdlog=sigma)]
